...
class Parser:
    ...
    def createWorkdir(self):
        ...
        self.directory_name = "Formal:::" + currentDate + ":::" + currentTime
    ...
    def extract_headers(self):
        ...
        try: 
            with open(os.path.join(self.path, self.filename), 'r') as file:
                ...
                print("[LOG] Formal Working directory --> ",self.directory_name)
                with open(file_path, "w") as file:
                    for match in matches:
            ...
            with open(os.path.join(self.path, self.filename), 'r') as file:
                ...
                for line in f_contents:
                    ...
                    for match in matches:
                        ...
                        newfile = open(extractedFunctionBodyName, 'w')
                        if arguments == "":
...
def main():
    obj = Parser('/Users/pathfinder/Work/Projects/SPARC/klee/examples/SPARC', 'test_pattern.cpp')
